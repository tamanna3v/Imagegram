...
{
    public abstract class ImagegramWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ImagegramWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ImagegramWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ImagegramDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ImagegramDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ImagegramDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ImagegramDbContext, Task<T>> func)
        {
            T result;
