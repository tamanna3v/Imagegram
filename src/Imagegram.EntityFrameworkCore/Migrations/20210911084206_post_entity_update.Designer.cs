...
namespace Imagegram.Migrations
{
    ...
    [Migration("20210911084206_post_entity_update")]
    partial class post_entity_update
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Imagegram.Imagegram.Comments", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Imagegram.Imagegram.Post", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Imagegram.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Imagegram.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Imagegram.Imagegram.Comments", b =>
                {
                    b.HasOne("Imagegram.Imagegram.Post", null)
                        .WithMany("Comments")
